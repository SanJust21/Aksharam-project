    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/beta/api/category/getAllTicketMode").permitAll()
                        ...
                        .requestMatchers("/beta/api/spotData/getCountAndGrandTotalByPaymentMode").hasAnyAuthority(Role.ADMIN.name())
                        ...
                        .requestMatchers("/beta/api/onlineBooking/**").permitAll()
