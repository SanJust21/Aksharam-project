    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/api/spotData/updateTypeGrandTotal").hasAnyAuthority(Role.ADMIN.name())
                        .requestMatchers("/api/spotData/getCountAndGrandTotalByPaymentMode").hasAnyAuthority(Role.ADMIN.name())
