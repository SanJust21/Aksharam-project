package com.example.MuseumTicketing.localServer.Digital.mainHeading;

import com.example.MuseumTicketing.localServer.Digital.SecondSubHeading.CombinedDataSubSub;
...
import com.example.MuseumTicketing.localServer.Digital.SecondSubHeading.english.SecondSubEnglish;
import com.example.MuseumTicketing.localServer.Digital.SecondSubHeading.english.SecondSubEnglishRepo;
import com.example.MuseumTicketing.localServer.Digital.SecondSubHeading.malayalam.SecondSubMalayalam;
import com.example.MuseumTicketing.localServer.Digital.SecondSubHeading.malayalam.SecondSubMalayalamRepo;
import com.example.MuseumTicketing.localServer.Digital.firstSubHeading.CombinedDataSub;
...
import com.example.MuseumTicketing.localServer.Digital.firstSubHeading.GetDtoSub;
import com.example.MuseumTicketing.localServer.Digital.firstSubHeading.english.FirstSubEnglish;
import com.example.MuseumTicketing.localServer.Digital.firstSubHeading.english.FirstSubEnglishRepo;
import com.example.MuseumTicketing.localServer.Digital.firstSubHeading.malayalam.FirstSubMalayalam;
import com.example.MuseumTicketing.localServer.Digital.firstSubHeading.malayalam.FirstSubMalayalamRepo;
import com.example.MuseumTicketing.localServer.Digital.mainHeading.mainMal.MainTitleMalRepo;
...
import com.example.MuseumTicketing.localServer.Digital.mainHeading.mainEng.MainTitleEng;
import com.example.MuseumTicketing.localServer.Digital.mainHeading.mainEng.MainTitleEngRepo;
import com.example.MuseumTicketing.localServer.Digital.mainHeading.mainMal.MainTitleMal;
...
public class MainTitleService {
    ...
    public ResponseEntity<?> uploadVideoFileData(MultipartFile file) {
        ...
        try {
            ...
            return new ResponseEntity<>(file.getOriginalFilename()+"  uploaded successfully : "+videoFile.getAbsolutePath(),HttpStatus.OK);
        }catch (IOException e){
            return new ResponseEntity<>("Failed to upload file"+e.getMessage(),HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }

    public ResponseEntity<StreamingResponseBody> getMultipartFile(String fileName, String rangeHeader) {
        try {
            ...
            StreamingResponseBody responseBody = outputStream -> {
                try (InputStream inputStream = resource.getInputStream()) {
                    ...
                    byte[] buffer = new byte[10240]; //8kb
                    long bytesRead;
